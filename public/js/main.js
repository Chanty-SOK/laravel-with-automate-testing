...
/* harmony default export */ __webpack_exports__["default"] = ((function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__('#addNewUserModal').on('show.bs.modal', function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0__["each"](jquery__WEBPACK_IMPORTED_MODULE_0__('input, select ,radio', '#addNewUserForm'), function (k) {
      jquery__WEBPACK_IMPORTED_MODULE_0__("#addNewUserForm [name*='" + jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('name') + "']").removeClass('is-invalid');
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__("#addNewUserForm").submit(function (e) {
    e.preventDefault();
    var form = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
    var url = form.attr('action');
    jquery__WEBPACK_IMPORTED_MODULE_0__["ajax"]({
      ...
      error: function error(data) {
        ...
        if (response.errors) {
          jquery__WEBPACK_IMPORTED_MODULE_0__["each"](response.errors, function (i, item) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#addNewUserForm [name*='" + i + "']").addClass('is-invalid');
            jquery__WEBPACK_IMPORTED_MODULE_0__('#addNewUserForm .error_' + i).html(item);
          });
        }
      }
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__('.editUserBtn').click(function () {
    window.$('#editUserModal').modal('show');
    jquery__WEBPACK_IMPORTED_MODULE_0__["each"](jquery__WEBPACK_IMPORTED_MODULE_0__('input, select ,radio', '#editUserForm'), function (k) {
      jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm [name*='" + jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('name') + "']").removeClass('is-invalid');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__["ajax"]({
      type: "GET",
      url: '/users/' + jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('item') + '/edit',
      success: function success(data) {
        jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm").attr('action', '/users/' + data.id);
        jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm [name*='name']").val(data.name);
        jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm [name*='email']").val(data.email);
        jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm [name*='password']").val(data.password);
        jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm [name*='role']").val(collect_js__WEBPACK_IMPORTED_MODULE_1___default()(data.roles).first().id);
        jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm [name*='status']").attr('checked', data.status == 0);
      },
      error: function error(data) {}
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm").submit(function (e) {
    e.preventDefault();
    var form = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
    var url = form.attr('action');
    jquery__WEBPACK_IMPORTED_MODULE_0__["ajax"]({
      ...
      error: function error(data) {
        ...
        if (response.errors) {
          jquery__WEBPACK_IMPORTED_MODULE_0__["each"](response.errors, function (i, item) {
            jquery__WEBPACK_IMPORTED_MODULE_0__("#editUserForm [name*='" + i + "']").addClass('is-invalid');
            jquery__WEBPACK_IMPORTED_MODULE_0__('#editUserForm .error_' + i).html(item);
          });
        }
      }
    });
...
/***/ 0:
/*!***************************************************************************!*\
  !*** multi ./resources/assets/scripts/index.js ./resources/sass/app.scss ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/chanty/Desktop/StudyCourse/Laravel/base-project-beniten/resources/assets/scripts/index.js */"./resources/assets/scripts/index.js");
module.exports = __webpack_require__(/*! /home/chanty/Desktop/StudyCourse/Laravel/base-project-beniten/resources/sass/app.scss */"./resources/sass/app.scss");
